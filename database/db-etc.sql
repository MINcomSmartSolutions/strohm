...
ALTER ROLE odoo_admin WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:5zZf62Kzy5Vn2EJOs9aZWQ==$FRL9Qdyl5LbvfacQeZnvXTdWEjoTwXepEbgHcc2W0y0=:4E+mus8zsXmkiynxSHUllm2+hJE8wl3Ci2ABKmzjnSw=';
ALTER ROLE odoo_admin WITH CREATEDB CREATEROLE;
-- Needed because of extension creation
